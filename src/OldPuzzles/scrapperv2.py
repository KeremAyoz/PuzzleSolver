...
def getCrossword(puzzleLink , puzzleDate = str(datetime.date.today())):
    ...
    solution_button = driver.find_element_by_css_selector(".Toolbar-expandedMenu--2s4M4").find_elements_by_css_selector(
        ".Tool-button--39W4J.Tool-tool--Fiz94.Tool-texty--2w4Br")[1]
    ...
    button = driver.find_element_by_css_selector(".buttons-modalButtonContainer--35RTh").find_elements_by_css_selector(
        ".buttons-modalButton--1REsR")[1]
    button.click()
...
while (year * 10000 + month * 100 + day) <= todayDate:
    ...
    getCrossword(puzzleLink , puzzleDate)
